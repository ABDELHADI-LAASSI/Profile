...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">developpeur Full Stack</h3>
            
            <p className="home__description">
            Abdelhadi Laassi, a second-year full-stack development student, passionate about computer science.            </p>
